all: builddir
	...
	(cd build && g++ -std=c++17 -o ../z80.out main.o z80.o iManager.o iSet.o incdecaddsub.o memoryManager.o mainIs.o bitIs.o ixcb.o iycb.o rotate.o arithmetic.o cpuctl.o bit.o)
