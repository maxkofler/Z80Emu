...
iManager.o: Z80/log/log.h iSet.o
	g++ -o build/iManager.o -c Z80/iManager/iManager.cpp

mainIs.o: Z80/log/log.h incdecaddsub.o
	g++ -o build/mainIs.o -c Z80/iManager/iSet/MAINIS/mainIs.cpp

incdecaddsub.o:	Z80/iManager/iSet/INCDECADDSUB/incdecaddsub.h
...
rotate.o: Z80/iManager/iSet/ROTATE/rotate.h
